      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="relative">
            ...
            {/* Подзаголовок с плавным появлением */}
            <div className="flex justify-end mb-8">
              <div className="w-full md:w-2/3 lg:w-1/2">
                <p className="text-xl md:text-2xl text-green-600 font-medium mb-6 animate-fade-in">
                  Вот что пишут наши клиенты после знакомства с нами
                </p>
                
                {/* Кнопка с hover-анимацией */}
                <button
                  onClick={nextTestimonial}
                  onMouseEnter={() => setIsAutoPlaying(false)}
                  onMouseLeave={() => setIsAutoPlaying(true)}
                  className="bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-bounce-slow"
                >
                  Листать отзывы →
                </button>
              </div>
        ...
        <div className="relative">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className={`text-sm ${
                          testimonial.theme === 'dark' ? 'text-green-400' : 'text-green-600'
                        }`}>
                          онлайн
                        </div>
                      </div>
          ...
          <div className="flex justify-center items-center space-x-4">
            <button
              ...
              className="p-3 rounded-full bg-white shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300"
            >
              ←
            </button>
          ...
          <div className="absolute -bottom-10 -right-10 w-20 h-20 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
